...
const WorkItems = ({year, title, duration, details}) => {
    ...
    <ol className="flex flex-row md:flex-row  ">
        <li className="mb-3 ml-4 grid sm:grid-cols-2 gap-12 border-l ">
            ...
            <p className="flex flex-wrap gap-4 flex-row items-start justify-start text-xs md:text-sm">
                ...
                <span className="text-lg font-semibold mt-7 text-gray-400">{title}</span>
                
            </p>
            <p className="m-2 pt-5 text-base font-normal text-stone-500 text-justify">{details}
